...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleSeriesDetailsComponent", function() { return ArticleSeriesDetailsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_dal_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/dal.service */ "./src/app/services/dal.service.ts");
...
let ArticleSeriesDetailsComponent = class ArticleSeriesDetailsComponent {
    constructor(route, seo, dal, im) {
        this.route = route;
        this.seo = seo;
        this.dal = dal;
        this.im = im;
    ...
    ngOnInit() {
        this.route.params.subscribe(params => {
            const { id, seriesName, articleName } = params;
            this.blogLink = '/series/article/' + seriesName + '/' + articleName + '/' + id;
            this.dal.getMdFile(this.blogLink).subscribe(x => {
                x = x[0];
                this.article = x;
                // this.article.authorDetails.profile = 'https://res.cloudinary.com/brainethic/image/upload/c_scale,w_245/v1571636313/IMG_1022_aamuxq.jpg'
                this.seo.setMDFileSEO(x);
                this.commentModel.articleId = x._id;
                this.fetchComments();
                if (this.article.authorId) {
                    this.dal.getUserDetails({ userId: this.article.authorId }).subscribe(x => {
                        x = x && x[0];
                        this.article.authorDetails = x.profile;
                    });
                }
            }, e => {
                console.log(e);
    ...
    shareArticle(type) {
        this.dal.articleStats(this.article._id, 'shares').subscribe(x => {
            console.log('Share incremented', x);
        });
        this.seo.socialShareService.share(type, this.article);
    }
    fetchComments() {
        this.dal.getComments({ articleId: this.commentModel.articleId }).subscribe(y => {
            this.comments = y;
        });
    }
    saveComment() {
        ...
        if (this.commentModel.name.trim().length < 3 || this.commentModel.email.trim().length < 10 || this.commentModel.comment.trim().length < 20) {
            this.im.publish(_services_im_service__WEBPACK_IMPORTED_MODULE_5__["IMEventTypes"].NOTIFICATION, { msg: 'Please fill name (min 3 char), email (valid) and comment (min 20 char) properly', type: _services_im_service__WEBPACK_IMPORTED_MODULE_5__["NotifTypes"].ERROR });
        }
        else {
            this.dal.postComment(this.commentModel).subscribe(x => {
                console.log(x);
                if (x._id) {
                    this.commentModel.name = '';
                    this.commentModel.email = '';
                    this.commentModel.comment = '';
                    this.im.publish(_services_im_service__WEBPACK_IMPORTED_MODULE_5__["IMEventTypes"].NOTIFICATION, { msg: 'Thank you for your comment', type: _services_im_service__WEBPACK_IMPORTED_MODULE_5__["NotifTypes"].SUCCESS });
                }
                this.fetchComments();
            });
        }
...
ArticleSeriesDetailsComponent.ctorParameters = () => [
...
ArticleSeriesDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-article-series-details',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./article-series-details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/article-series-details/article-series-details.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./article-series-details.component.css */ "./src/app/components/article-series-details/article-series-details.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleSeriesListComponent", function() { return ArticleSeriesListComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ArticleSeriesListComponent = class ArticleSeriesListComponent {
    constructor(dal, route) {
        this.dal = dal;
        this.route = route;
        this.header = {
    ...
    ngOnInit() {
        ...
        this.dal.getArticles({ "status": "PUBLISHED", skipFields: 'blogData,authorDetails' }).subscribe(x => {
            this.articles = x;
            this.route.params.subscribe(params => {
                const { seriesName } = params;
                this.activeId = seriesName;
                this.matchedArticleCount = this.articles.filter(x => x.seriesType === seriesName).length;
            });
        });
    }
    searchArticle(searchQuery) {
        this.dal.searchArticle(searchQuery).subscribe((x) => {
            this.filteredArticles = x;
            console.log(x);
        });
    }
};
ArticleSeriesListComponent.ctorParameters = () => [
    { type: _services_dal_service__WEBPACK_IMPORTED_MODULE_2__["DalService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
ArticleSeriesListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-article-series-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./article-series-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/article-series-list/article-series-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./article-series-list.component.css */ "./src/app/components/article-series-list/article-series-list.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleseriesRoutingModule", function() { return ArticleseriesRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _components_article_series_list_article_series_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/article-series-list/article-series-list.component */ "./src/app/components/article-series-list/article-series-list.component.ts");
/* harmony import */ var _components_article_series_details_article_series_details_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/article-series-details/article-series-details.component */ "./src/app/components/article-series-details/article-series-details.component.ts");
...
const routes = [
    {
        path: "list", component: _components_article_series_list_article_series_list_component__WEBPACK_IMPORTED_MODULE_3__["ArticleSeriesListComponent"]
    },
    {
        path: "list/:seriesName", component: _components_article_series_list_article_series_list_component__WEBPACK_IMPORTED_MODULE_3__["ArticleSeriesListComponent"]
    },
    {
        path: "article/:seriesName/:articleName/:id", component: _components_article_series_details_article_series_details_component__WEBPACK_IMPORTED_MODULE_4__["ArticleSeriesDetailsComponent"]
    }
];
let ArticleseriesRoutingModule = class ArticleseriesRoutingModule {
};
ArticleseriesRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleseriesModule", function() { return ArticleseriesModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _articleseries_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./articleseries-routing.module */ "./src/app/modules/articleseries/articleseries-routing.module.ts");
/* harmony import */ var _components_article_series_list_article_series_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/article-series-list/article-series-list.component */ "./src/app/components/article-series-list/article-series-list.component.ts");
/* harmony import */ var _components_article_series_details_article_series_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/article-series-details/article-series-details.component */ "./src/app/components/article-series-details/article-series-details.component.ts");
/* harmony import */ var _course_shared_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../course/shared.module */ "./src/app/modules/course/shared.module.ts");
...
let ArticleseriesModule = class ArticleseriesModule {
};
ArticleseriesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _components_article_series_details_article_series_details_component__WEBPACK_IMPORTED_MODULE_5__["ArticleSeriesDetailsComponent"],
            _components_article_series_list_article_series_list_component__WEBPACK_IMPORTED_MODULE_4__["ArticleSeriesListComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _course_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"],
            _articleseries_routing_module__WEBPACK_IMPORTED_MODULE_3__["ArticleseriesRoutingModule"],
...
//# sourceMappingURL=modules-articleseries-articleseries-module-es2015.js.map